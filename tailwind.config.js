...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-pattern": "url('/Beep Beep - Mountains.png')",
        "aquatic-nebula": "url('/Aquatic Nebula.jpg')",
        "para3-home": "url('/para3-home.jpg')",
        "para2-home": "url('/5484597.jpg')",
        "Friendly-blobs": "url('/Friendly Blobs.png')",
      },
    },
  },
  plugins: [
